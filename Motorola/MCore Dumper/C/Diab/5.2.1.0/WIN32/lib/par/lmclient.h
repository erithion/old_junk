/*****************************************************************************
      ...
      COPYRIGHT (c) 1988, 2002 by Globetrotter Software Inc.
 ...
 *****************************************************************************/
/*
 *  Module: $Id: lmclient.h,v 1.161 2002/01/22 00:20:08 daniel Exp $
 *
...
#define FLEXLM_VERSION 8
#define FLEXLM_REVISION 1
#define FLEXLM_PATCH "a"
#define FLEXLM_COPYRIGHT_YEAR "2002"
...
/*#define LM_FLOATOK_NOHOSTID -103*/ /* "FLOAT_OK requires a server hostid" */
...
#define LM_BEHAVIOR_CURRENT LM_BEHAVIOR_V8_1
...
#define LM_CODE_GEN_INIT(code) \
  ...
  { \
    ...
    { \
      ...
      (code)->pubkeyinfo[pcnt].pubkey_fptr = l_prikey_sign; \
...
#define CHECK_HOSTID_INTERVAL 30      /* at most, check
        ...
        lm_args((LM_VOID_PTR, LM_U_CHAR_PTR, int ));
         ...
         char *keymem3;
         char *extra1; 
         unsigned short borrow_linger_minutes;
...
#define lm_isres(x) ((x) & (HOSTGROUPRES | HOSTRES | USERRES | DISPLAYRES | GROUPRES | INTERNETRES | PROJECTRES | BORROWEDLIC | UNKNOWNRES))
