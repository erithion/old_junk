...
j_ldc,          // ig, added for jasmin because it doesn't understand ldc1, ldc2
//
...
// Unfortunately, the instruction descriptions are not available
...
MIPS_ei,                // Enable interrupt
MIPS_di,                // Disable interrupt
