...
idaman char *ida_export get_loader_name(void);
...
idaman char *ida_export get_file_type_name(char *buf, size_t bufsize);
...
#define PLUGIN_DBG  0x0020      // A debugger plugin. run(arg) should put
                                // the address of debugger_t to *arg
