...
//
//      This file contains 'inf' structure definition and some
//      common to all project functions.
//      'inf' structure is saved in the database and contains information
...
#define LN_WEAK         0x08            //   weak names
  ...
  uchar         s_reserved4;            // old compiler
  uchar         s_reserved5;            // old memory model & calling convention
  uchar         s_reserved3;            // old lenascii (margin)
...
#define AF2_DATOFF      0x0200          // Automatically convert data to offsets
  ...
  static int    retrieve(void);         // low level function to get this
                                        // structure from the database
  static int    read(const char *basename); // high level function to get
