...
#define         IDD_INTERFACE_VERSION   6
...
#define DBG_FLAG_REMOTE 0x01                // Remote debugger (requires remote host name)
...
// Open/close/read a remote file
  int  (idaapi* open_file)(const char *file, ulong *fsize); // -1-error
