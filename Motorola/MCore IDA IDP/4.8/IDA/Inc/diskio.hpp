...
idaman ulong ida_export qlsize(linput_t *li);


// Set input source position
// Returns the new position (not 0 as fseek!)

idaman ulong ida_export qlseek(linput_t *li, ulong pos, int whence=SEEK_SET);


// Get input source position

inline ulong idaapi qltell(linput_t *li) { return qlseek(li, 0, SEEK_CUR); }
